...
class REFCOCOG_EVAL():
    ...
    def forward_single(self, inputs):
        ...
        img_path = os.path.join(self.root_path, inputs['file_name'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--json', help='path to refcocog val json file', default='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/liangyaoyuan/github/other_llm_box/Osprey/osprey/eval/finetune_refcocog_val_with_mask.json')
