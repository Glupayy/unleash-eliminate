...
from model.osprey.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from .osprey_trainer import OspreyTrainer

from model.osprey import conversation as conversation_lib
...
def train():
    ...
    trainer = OspreyTrainer(model=model,
                    tokenizer=tokenizer,
                    args=training_args,
                    **data_module)
